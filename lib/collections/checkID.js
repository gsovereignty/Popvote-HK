Meteor.methods({
    checkHKID: function (hkid) {
        if (hkid.length > 9){throw new Meteor.Error('invalid', 'The HKID entered is invalid')} else {
        if (hkid.length < 8){throw new Meteor.Error('invalid', 'The HKID entered is invalid')} else {
