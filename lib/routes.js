...
Router.route('/allvotes', {name: 'votesList'});
...
Router.route('/checkid', {name: 'checkHkid'});
Router.route('/registerdetails', {name: 'registerDetails'});
...
Router.route('/votes/editpolivotes/:_id', {
  name: 'editPolivotes',
  data: function() { return VotesCollection.findOne(this.params._id); }
});